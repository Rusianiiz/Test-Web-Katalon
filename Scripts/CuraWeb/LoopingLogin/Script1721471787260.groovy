...
"Memanggil Test Data"
TestData data = findTestData('Data Files/DDTLooping')

"Mendapatkan jumlah baris dalam file TestData"
int hitungbarisexcel = data.getRowNumbers()
...
for ( int i = 1; i <= hitungbarisexcel.toInteger(); i++) {
    ...
    WebUI.setEncryptedText(findTestObject('Object Repository/Login/SpyWeb/Login Toggle Menu/Page_CURA Healthcare Service/input_Password_password'), 
